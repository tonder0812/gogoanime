...
if True:
    ...
    def init_color(__color_number: int, __r: int,
                   __g: int, __b: int) -> None: ...
    ...
    def newwin(__nlines: int, __ncols: int, __begin_y: int = ...,
               __begin_x: int = ...) -> _CursesWindow: ...
    ...
    def ungetmouse(__id: int, __x: int, __y: int,
                   __z: int, __bstate: int) -> None: ...
    ...
    class _CursesWindow:
        ...
        @overload
        def addnstr(self, y: int, x: int, str: str,
                    n: int, attr: int = ...) -> None: ...
        ...
        @overload
        def insnstr(self, y: int, x: int, str: str,
                    n: int, attr: int = ...) -> None: ...
