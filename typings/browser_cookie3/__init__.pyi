...
class ChromiumBased:
    ...
    def __init__(self, browser: str, cookie_file: str | None = ..., domain_name: str | None = ..., key_file: str | None = ..., **kwargs: Any) -> None:
        ...
...
class Chrome(ChromiumBased):
    ...
    def __init__(self, cookie_file: str | None = ..., domain_name: str | None = ..., key_file: str | None = ...) -> None:
        ...
...
class Firefox:
    ...
    def __init__(self, cookie_file: str | None = ..., domain_name: str | None = ...) -> None:
        ...
...
def chrome(cookie_file: str | None = ..., domain_name: str | None = ..., key_file: str | None = ...) -> CookieJar:
...
def chromium(cookie_file: str | None = ..., domain_name: str | None = ..., key_file: str | None = ...) -> CookieJar:
...
def opera(cookie_file: str | None = ..., domain_name: str | None = ..., key_file: str | None = ...) -> CookieJar:
...
def brave(cookie_file: str | None = ..., domain_name: str | None = ..., key_file: str | None = ...) -> CookieJar:
...
def edge(cookie_file: str | None = ..., domain_name: str | None = ..., key_file: str | None = ...) -> CookieJar:
...
def vivaldi(cookie_file: str | None | None = ..., domain_name: str | None = ..., key_file: str | None = ...) -> CookieJar:
